...
if __name__ == '__main__':
    tree = BST()
    tree.insert("nick","kings",98765432, "nickkings@mail.cl")
    tree.insert("valry", "trinca2", 89876543, "valetri@gmail.gg")
    tree.insert("john","culaio",666655555, "chualo@gmail.com")
    tree.in_order(None)
